...
public class ActivityCTusing extends AppCompatActivity {
    ...
    class Connector extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = "http://10.216.2.136/android_connect/ct.php"; //10.216.2.136  10.236.39.36 10.236.46.44 holds the link for the php file I want to connect to
            try{
            ...
            runOnUiThread(new Runnable() { //runONUi thread allows content to run on main thread since, only there can necessary code be run
                @Override
                public void run() {
                    setContentView(R.layout.activity_ctusing); //adds desired layout to be displayed
                    TextView textView3 = (TextView)findViewById(R.id.textViewctusing); //connects a text variable to text button in the layout
